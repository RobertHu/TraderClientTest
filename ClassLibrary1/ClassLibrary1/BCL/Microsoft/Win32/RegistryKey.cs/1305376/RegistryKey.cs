...
[System.Runtime.InteropServices.ComVisible(true)] 
    ...
    { 
        ...
        private RegistryView regView = RegistryView.Default;
        ...
        { 
            ...
            int ret = Win32Native.RegCreateKeyEx(hkey,
                ...
                GetRegistryKeyAccess(permissionCheck != RegistryKeyPermissionCheck.ReadSubTree, regView), 
                secAttrs,
                out result, 
                out disposition); 
        ...
        public RegistryKey OpenSubKey(string name, bool writable ) { 
            ...
            SafeRegistryHandle result = null; 
            int ret = Win32Native.RegOpenKeyEx(hkey, name, 0, GetRegistryKeyAccess(writable, regView), out result); 
        ...
        public RegistryKey OpenSubKey(String name, RegistryKeyPermissionCheck permissionCheck) {
            ValidateKeyMode(permissionCheck); 
            return InternalOpenSubKey(name, permissionCheck, GetRegistryKeyAccess(permissionCheck, regView)); 
        }
        ...
        public SafeRegistryHandle Handle { 
            ...
            get {
                ...
                if (IsSystemKey()) {
                    ...
                    ret = Win32Native.RegOpenKeyEx(baseKey, null, 0, GetRegistryKeyAccess(IsWritable(), regView), out result);
                    if (ret == 0 && !result.IsInvalid) {
                        return result; 
                    }
                    else { 
        ...
        internal String[] InternalGetSubKeyNames() {
            ...
            if (subkeys > 0) { 
                StringBuilder name = new StringBuilder(MaxKeyLength+1);
                int namelen; 
        ...
        public String[] GetValueNames() {
            ...
            if (values > 0) { 
                StringBuilder name = new StringBuilder(MaxValueLength+1); 
                int namelen;
...
*/ 
        ...
        static int GetRegistryKeyAccess(bool isWritable, RegistryView view) {
            int winAccess; 
            if (!isWritable) {
            ...
            winAccess = winAccess | (int)view; 
            return winAccess;
        } 

        static int GetRegistryKeyAccess(RegistryKeyPermissionCheck mode, RegistryView view) {
            int winAccess = 0;
            switch(mode) { 
