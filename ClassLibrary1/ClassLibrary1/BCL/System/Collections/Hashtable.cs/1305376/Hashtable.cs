...
#pragma warning restore 618
        ...
        public virtual void OnDeserialization(Object sender) {
            if (buckets!=null) { 
                ...
                // We can't really fix this problem easily.  With any hack we do, lookups 
                // may fail then succeed after this method has been called.  That 
                // may break consistency elsewhere in the application.  It's probably
                // better for us to report this type of failure. 
                // HOWEVER, Serialization will currently call OnDeserialization multiple
                // times on the same instance, so we can't quite add this logic in here yet.
                // Uncomment the throw once DevDiv Bug 1056 is fixed, probably by September 2006.
                return;  // @ 
                //Contract.Assert(false, "Someone stored something in a Hashtable before it was fully deserialized!  Don't do this.  It might break some consistency guarantee in the application.");
                //throw new SerializationException(Environment.GetResourceString("Serialization_ObjectUsedBeforeDeserCallback")); 
            } 
