    ...
    public struct DateTime : IComparable, IFormattable, IConvertible, ISerializable, IComparable<DateTime>,IEquatable<DateTime> { 
        ...
        public static DateTime FromBinary(Int64 dateData) { 
            if ((dateData & (unchecked( (Int64) LocalMask))) != 0) {
                ...
                Int64 offsetTicks; 
                if (ticks < MinTicks) {
                    offsetTicks = TimeZoneInfo.Local.GetUtcOffset(DateTime.MinValue, TimeZoneInfoOptions.NoThrowOnInvalidTime).Ticks;
                }
                else if (ticks > MaxTicks) { 
                    offsetTicks = TimeZoneInfo.Local.GetUtcOffset(DateTime.MaxValue, TimeZoneInfoOptions.NoThrowOnInvalidTime).Ticks;
                } 
                else { 
        ...
        public Int64 ToBinary() {
            if (Kind == DateTimeKind.Local) {
                ...
                TimeSpan offset = TimeZoneInfo.Local.GetUtcOffset(this, TimeZoneInfoOptions.NoThrowOnInvalidTime);
                Int64 ticks = Ticks; 
