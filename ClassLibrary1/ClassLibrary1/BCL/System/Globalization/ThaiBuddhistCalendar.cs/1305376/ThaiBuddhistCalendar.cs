...
[System.Runtime.InteropServices.ComVisible(true)]
    [Serializable] public class ThaiBuddhistCalendar: Calendar { 
        ...
        static internal EraInfo[] thaiBuddhistEraInfo = InitEraInfo(); 

        static EraInfo[] InitEraInfo()
        {
            EraInfo[] eraRanges = new EraInfo[1]; 
            eraRanges[0] = new EraInfo( 1, 1, 1, 1, -543, 544, GregorianCalendar.MaxYear + 543);     // era #, start year/month/day, yearOffset, minEraYear
            return eraRanges; 
        } 
