...
namespace System.IO.IsolatedStorage {
    ...
    { 
        ...
        internal void Init(IsolatedStorageScope scope) 
        {
            ...
            Contract.Assert(LongPathDirectory.Exists(m_RootDir), "LongPathDirectory.Exists(m_RootDir)");
    ...
    // Not being used right now
        ...
        internal static String[] GetFileDirectoryNames(String path, String userSearchPattern, bool file) 
        {
            ...
            if (hr!=0 && hr!=Win32Native.ERROR_NO_MORE_FILES) __Error.WinIOError(hr, userSearchPattern); 
