...
[System.Runtime.InteropServices.ComVisible(true)] 
    ...
    { 
        ...
        private static extern void SetMethodIL(RuntimeModule module, int tk, bool isInitLocals,
            ...
            int maxStackSize, 
            __ExceptionInstance[] exceptions, int numExceptions, 
            int [] tokenFixups, int numTokenFixups,
            int [] rvaFixups, int numRvaFixups); 
        ...
        { 
            ...
            { 
                ...
                if (destType.IsEnum) 
                {
                    ...
                    {
                        underlyingType = enumBldr.UnderlyingSystemType; 
                        ...
                        if (type != enumBldr.RuntimeEnumType && type != underlyingType) 
                            throw new ArgumentException(Environment.GetResourceString("Argument_ConstantDoesntMatch"));
                    } 
                    else if ((typeBldr = destType as TypeBuilder) != null) 
                    {
                        underlyingType = typeBldr.m_underlyingSystemType; 

                        // The constant value supplied should match either the baked enum type or its underlying type
                        // typeBldr.m_underlyingSystemType is null if the user hasn't created a "value__" field on the enum
                ...
                CorElementType corType = RuntimeTypeHandle.GetCorElementType(type.GetTypeHandleInternal().GetRuntimeType()); 
        ...
        private Type m_underlyingSystemType; // set on the underlying TypeBuilder When a user defines a literal on an EnumBuilder 
...
[System.Runtime.InteropServices.ComVisible(true)]
        ...
        public override bool IsAssignableFrom(Type c)
        {
            ...
            if (fromTypeBuilder != null)
                fromRuntimeType = fromTypeBuilder.m_runtimeType;
            else
                fromRuntimeType = c; 

            if (fromRuntimeType != null && fromRuntimeType.IsRuntimeType) 
            { 
                ...
                return m_runtimeType.IsAssignableFrom(fromRuntimeType); 
            }
        ...
        public override bool IsSecurityCritical 
        {
            get
            {
                ...
                return m_runtimeType.IsSecurityCritical;
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return m_runtimeType.IsSecuritySafeCritical;
            }
        } 
        ...
        { 
            ...
            { 
                ...
                return m_runtimeType.IsSecurityTransparent;
            } 
        } 
...
[System.Runtime.InteropServices.ComVisible(true)]
        ...
        private Type CreateTypeNoLock() 
        {
            ...
            for(int i = 0; i < size; i++)
            {
                ...
                if (meth.m_ilGenerator != null) 
                {
                    maxstack = meth.m_ilGenerator.GetMaxStackSize() + meth.GetNumberOfExceptions(); 
                } 
                else
                { 
                ...
                SetMethodIL(m_module.GetNativeHandle(), meth.GetToken().Token, meth.InitLocals, 
                    ...
                    RVAFixups, (RVAFixups != null) ? RVAFixups.Length : 0);
