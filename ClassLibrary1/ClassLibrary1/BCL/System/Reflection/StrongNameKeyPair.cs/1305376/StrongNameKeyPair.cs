        ...
        private unsafe byte[] ComputePublicKey() 
        {
            ...
            { 
                ...
                try 
                {
                    ...
                    if (_keyPairExported) 
                    {
                        result = Win32Native.StrongNameGetPublicKey(null, _keyPairArray, _keyPairArray.Length, 
                            out pbPublicKey, out cbPublicKey);
                    }
                    else
                    { 
                        result = Win32Native.StrongNameGetPublicKey(_keyPairContainer, null, 0,
                            out pbPublicKey, out cbPublicKey); 
                    } 
                    if (!result)
                    ...
                    Buffer.memcpy(pbPublicKey, 0, publicKey, 0, cbPublicKey);
                } 
                finally
                { 
                    if (pbPublicKey != null) 
                        Win32Native.StrongNameFreeBuffer(pbPublicKey);
                } 
            }
            return publicKey;
        }
        ...
        { 
            ...
            { 
                ...
                try
                {
                    ...
                    publicKey = new byte[cbPublicKey];
                    Buffer.memcpy((byte*) (pbPublicKey.ToPointer()), 0, publicKey, 0, cbPublicKey); 
                }
                finally
                {
