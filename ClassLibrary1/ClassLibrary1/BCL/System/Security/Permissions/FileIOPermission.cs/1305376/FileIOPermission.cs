...
#if FEATURE_CORECLR
        internal static bool HasIllegalCharacters(String str) 
        {
            bool fHasInvalidCharacters = false;

            try { 
                String[] strArr = new String[1];
                strArr[0] = str; 
 
                HasIllegalCharacters(strArr);
            } 
            catch (ArgumentException) {
                fHasInvalidCharacters = true;
            }
 
            return fHasInvalidCharacters;
        } 
#endif 
