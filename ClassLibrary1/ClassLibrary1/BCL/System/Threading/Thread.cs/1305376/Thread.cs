...
[System.Runtime.InteropServices.ComVisible(true)]
    public sealed class Thread : CriticalFinalizerObject, _Thread 
    {
        ...
        ** DON'T CHANGE THESE UNLESS YOU MODIFY ThreadBaseObject in vm\object.h 
        ...
        internal List<CancellationSignal> m_CancellationSignals;  // IO Cancellation stack 
#endif 
...
#if IO_CANCELLATION_ENABLED
        internal List<CancellationSignal> CancellationSignals {
            [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)] 
            get {
                if (m_CancellationSignals == null) { 
                    List<CancellationSignal> signals = new List<CancellationSignal>(); 
