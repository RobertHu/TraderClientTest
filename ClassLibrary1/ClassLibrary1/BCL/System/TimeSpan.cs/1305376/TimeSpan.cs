...
#endif
    {
        ...
        private static bool GetLegacyFormatMode() { 
            ...
            if (LegacyFormatMode()) // FCALL to check COMPLUS_TimeSpan_LegacyFormatMode 
                return true;
            Nullable<bool> compatSwitch = AppDomain.CurrentDomain.IsCompatibilitySwitchSet("NetFx40_TimeSpanLegacyFormatMode");
#else
            Nullable<bool> compatSwitch = AppDomain.CurrentDomain.IsCompatibilitySwitchSet("APP_EARLIER_THAN_SL4.0"); 
#endif // !FEATURE_CORECLR
