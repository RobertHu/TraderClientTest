        ...
        private static Object s_internalSyncObject {
            get {
                if (s_hiddenInternalSyncObject == null) { 
                    Object o = new Object();
                    Interlocked.CompareExchange<Object>(ref s_hiddenInternalSyncObject, o, null); 
                } 
                ...
                if (!s_allSystemTimeZonesRead) { 
                    ...
                    using (RegistryKey reg = Registry.LocalMachine.OpenSubKey( 
                        ...
                        if (reg == null) {
                            ...
                            //
                            List<TimeZoneInfo> systemList; 
                            if (s_systemTimeZones != null) {
                                // return a collection of the cached system time zones 
                                systemList = new List<TimeZoneInfo>(s_systemTimeZones.Values); 
                            }
                            else { 
                                // return an empty collection
                                systemList = new List<TimeZoneInfo>();
                            }
                            s_readOnlySystemTimeZones = new ReadOnlyCollection<TimeZoneInfo>(systemList); 
                    ...
                    List<TimeZoneInfo> list = new List<TimeZoneInfo>(s_systemTimeZones.Values);
                    list.Sort(comparer);
