...
LRESULT CMainFrame::OnAppAboutAx(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	CAxAboutDlg dlg;
	dlg.DoModal();
	return 0;
...
LRESULT CMainFrame::OnAppTestPS(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	TestPS dlg;
	dlg.DoModal();
	return 0;
